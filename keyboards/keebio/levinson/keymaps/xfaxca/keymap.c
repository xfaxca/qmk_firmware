...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[1] = LAYOUT_ortho_4x12(KC_GRV, KC_EXLM, KC_AT, KC_HASH, KC_DLR, KC_PERC, KC_CIRC, KC_AMPR, KC_ASTR, KC_LPRN, KC_RPRN, KC_BSPC, KC_DEL, KC_F1, KC_F2, KC_F3, KC_F4, KC_F5, KC_F6, KC_UNDS, KC_PLUS, KC_PGDN, KC_PGUP, LT(3,KC_ENT), KC_BSPC, KC_F7, KC_F8, KC_F9, KC_F10, KC_F11, KC_F12, KC_PIPE, KC_ASTR, KC_HOME, KC_END, KC_ENT, RESET, KC_NO, KC_NO, KC_NO, KC_TRNS, KC_SPC, KC_INS, MO(5), KC_LEFT, KC_DOWN, KC_UP, KC_RGHT),
